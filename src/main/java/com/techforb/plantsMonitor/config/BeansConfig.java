...
public class BeansConfig {
    ...
    @Bean
    public ServletWebServerFactory servletContainer(@Value("${http.port}") int httpPort, @Value("${server.port}") int httpsPort) {
        ...
        tomcat.addAdditionalTomcatConnectors(connector, httpsConnector);
        return tomcat;
    }
}
